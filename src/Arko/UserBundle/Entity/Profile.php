...
namespace Arko\UserBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="Arko\UserBundle\Repository\ProfileRepository")
 */
class Profile
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Arko\UserBundle\Entity\User", inversedBy="profile")
     * @ORM\JoinColumns({
